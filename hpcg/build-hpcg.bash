...
function main()
{
  ...
  #module use /scratch/work/scc23/group/ys4680/apps/modulefiles
  module use /scratch/work/scc23/apps/modulefiles
  ...
  module load openmpi/intel/4.1.6
  ...
  export INCLUDE_FLAGS_FOR_INTEL_COMPILERS="-I$INTEL_INC -I$MKL_INC -I$MKLROOT/include"
  
  export LINK_FLAGS_FOR_INTEL_COMPILERS="-shared-intel -L$MKLROOT/lib/intel64"
